...
public class FeiyuClueTest {
    ...
    public static void main(String[] args) {
        String path = "D:\\360极速浏览器下载\\飞鱼CRM销售线索数据 (78).xlsx";
        FeiyuClueTest feiyuClueTest = new FeiyuClueTest();

        List<FeiyuClue> phoneNumberListFromExcel = feiyuClueTest.getFeiyuClueFromExcel(path);
        for (int i=0;i<=phoneNumberListFromExcel.size();i++){
            System.out.println(phoneNumberListFromExcel.get(i));
        }

    }

    public static FeiyuClue rowToFeiyuclue(Row row) {
...
// 广告id
        ...
        cell20.setCellType(HSSFCell.CELL_TYPE_STRING);
        feiyuClue.setAdId(cell20.getStringCellValue());
//计划名称
...
//广告主名称
     ...
     * 读取电话列表
     * */
    public static List<FeiyuClue> getFeiyuClueFromExcel(String excelPath) {
